...
- **License / FeatureGate is fail-CLOSED.** Free-tier installs must deny Pro/Enterprise endpoints (was a real bypass bug fixed in v0.1.6). Any new gated endpoint should call the FeatureGate; missing the gate is a security issue, not a UX one.
