...
interface Domain {
  ...
  dkim_selector: string; dkim_key_path?: string; spam_threshold: number; created_at: string;
}
  ...
  return (
    <div>
      ...
      <div className="card">
        <table>
          <thead>
            <tr><th>Domain</th><th>Active</th><th>DKIM</th><th>Selector</th><th>Created</th><th></th></tr>
          </thead>
          <tbody>
            {domains.map(d => (
              <tr key={d.id}>
            ...
            {domains.length === 0 && <tr><td colSpan={6} className="text-muted">No domains yet</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
